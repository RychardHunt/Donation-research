...
const commClient = async () =>
  await bandClient.at("0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB");

// Send 1000 community tokens to the community escrow
async () => await commClient.sendRevenue("1000");
...
console.log(async () => await commClient.getReward(2));

// Send a transaction to claim reward
async () => await commClient.sendClaimReward(2);
